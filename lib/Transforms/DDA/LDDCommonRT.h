...
unsigned findRWAddrIDIndex(std::vector<RWAddrID> &RWTrace, std::string AddrPos, 
        std::string VarName);
...
void __storecheckstackvar( int *ptr, long AddrLen, char *Pos, char* Name, 
    int TargetLoopFunc);               
void __loadcheckstackvar( int *ptr, long AddrLen, char *Pos, char* Name, 
    int TargetLoopFunc);
